# Persona 02: Vendor onboarding担当
...
| id | `02` |
| cluster | 正統派 |
| persona | Vendor onboarding担当 |
| department_role | 管理 / 購買寄り |
| initial_theme | 新規vendor onboarding desk |
...
> 新規vendor onboarding desk

## Source Behavior

質問された時に出してよいsource候補、または出せない理由をここから使う。

既存フォーム案、法務/経理チェックリスト、過去メール、登録ルール、承認者
...
| 00_lens | 新規業務として材料、owner、approval、外部取引先影響を粗く切る |
