...
| cluster | 支離滅裂 |
| persona | まとまらない依頼者 |
| department_role | 事業横断っぽい |
| initial_theme | AI秘書で売上、採用、クレームを全部いい感じに |
...
> AI秘書で売上、採用、クレームを全部いい感じに

## Source Behavior

質問された時に出してよいsource候補、または出せない理由をここから使う。

10に渡す対象がない。候補業務、実作業者、資料を00で再確認
...
| 00_lens | 業務候補、owner、source対象を1つに絞らせる |
