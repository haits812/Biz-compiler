# Work Card: 職場SES業務委託メタファーをMEMORYへ残す

- work_id: 20260615-200302-職場ses業務委託メタファーをmemoryへ残す
- registered_at: 2026-06-15 20:03:02 +09:00
- kind: docs
- state: completed
- executor: codex
- risk: low
...
Biz-compilerの説明メタファーとして、script全自動=業務委託、HITLあり=派遣社員、操作側=人材派遣会社という候補を短期メモに残す。

## Impact

MEMORY.mdの未整理メモだけに影響。正式なCompass/Decision反映はまだしない。
...
- status: pending
- close command: `knowledge/ops/orchestrators/impact-orchestrator/impact-orchestrator.ps1 -Complete -WorkCard "knowledge/journal/work/20260615-200302-職場ses業務委託メタファーをmemoryへ残す.md" -Result "..." -Verified "..." -ResidualRisk "..."`
...
- completed_at: 2026-06-15 20:04:59 +09:00
- status: completed
- result: 職場SES/業務委託/派遣会社メタファーをMEMORY.mdの未整理メモへ追記
