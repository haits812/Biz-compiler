# Work Card: setup.mdを追加する

- work_id: 20260615-153858-setup-mdを追加する
- registered_at: 2026-06-15 15:38:58 +09:00
- kind: ops
- state: completed
- executor: codex
- risk: low
...
clone直後の初期セットアップ、依存、hook接続、生成物、確認コマンドの入口としてroot直下にsetup.mdを追加する

## Impact

root構成、Hello-world生成、AGENTSの読み込み/配置ルール、READMEの入口説明、artifact placement、meta台帳、hello-world-gate必須ファイルに影響
...
- knowledge/docs/meta/artifact-placement.md
  ...
  - knowledge/docs/meta/README.md:49
  ...
  - knowledge/journal/work/20260615-150433-sqlite-knowledge-searchを追加.md:26
  - knowledge/journal/work/20260615-150433-sqlite-knowledge-searchを追加.md:72
  - knowledge/journal/work/20260615-150433-sqlite-knowledge-searchを追加.md:119
  - knowledge/journal/work/20260615-150433-sqlite-knowledge-searchを追加.md:155
  - knowledge/journal/work/20260615-150433-sqlite-knowledge-searchを追加.md:156
  - knowledge/journal/work/20260615-150433-sqlite-knowledge-searchを追加.md:199
  - knowledge/journal/work/20260615-150433-sqlite-knowledge-searchを追加.md:207
  - knowledge/journal/work/20260615-152307-knowledge-search自然言語トリガーを明記する.md:97
  - knowledge/journal/work/20260615-152307-knowledge-search自然言語トリガーを明記する.md:117
  - knowledge/journal/work/20260615-152307-knowledge-search自然言語トリガーを明記する.md:155
  - knowledge/journal/work/20260615-152307-knowledge-search自然言語トリガーを明記する.md:156
  - ... truncated at 25 references
- knowledge/ops/skills/hello-world-gate/SKILL.md
  - AGENTS.md:104
  - AGENTS.md:133
...
- status: pending
- close command: `knowledge/ops/orchestrators/impact-orchestrator/impact-orchestrator.ps1 -Complete -WorkCard "knowledge/journal/work/20260615-153858-setup-mdを追加する.md" -Result "..." -Verified "..." -ResidualRisk "..."`
...
- completed_at: 2026-06-15 15:43:54 +09:00
- status: completed
- result: root直下にsetup.mdを追加し、clone直後の必要ツール、hook正本導線、生成物、knowledge-search index、確認コマンドを整理した。Hello World Gateの必須rootファイルにも追加した。
- verified: PowerShell AST parse。git diff --check。python --version。knowledge-search status。rgでsetup.md/hook正本導線を確認。
- residual_risk: 環境側hook接続そのものは各Codex/Claude Code環境で設定する必要がある。setup.mdにはhook一覧を複製しない。
- released_locks: 7
