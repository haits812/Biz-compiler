...
## 現在地
Hello World、Memory、直近の差分、作業中ファイルなどから分かる現在地を書く。
...
| 現在地 | `Hello,world.md` と `MEMORY.md` を優先する |
...
| 更新対象 | `MEMORY.md`、meta ledger、Hello World、Decisionなどを確認する |
...
session brief型を変える場合は、`knowledge/docs/meta/README.md`、`knowledge/docs/README.md`、`MEMORY.md`、必要なら `subagent-brief.md` を確認する。