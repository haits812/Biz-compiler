...
subagent委譲の型を変える場合は、`COMPASS.md` のRole / Delegation Use、`knowledge/docs/README.md` のSubagent Delegation、`session-brief.md`、`knowledge/docs/meta/README.md` を確認する。`MEMORY.md` は正本重複を増やしていないかだけ確認する。
