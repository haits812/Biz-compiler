...
| state-model | State model | 整備状態、主張状態、pending運用状態を分ける | 整備済み | `knowledge/docs/meta/state-model.md` | `knowledge/ops/skills/knowledge-curation/` | `knowledge/docs/meta/README.md` | なし | 台帳/pending運用で維持 |
