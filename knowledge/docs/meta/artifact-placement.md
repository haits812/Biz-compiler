...
新しい置き場を作る場合は、`AGENTS.md`、`Hello,world.md`、`MEMORY.md`、`knowledge/docs/README.md`、`knowledge/docs/meta/README.md` のどれへ影響するかを確認する。root構成、`template/`、`knowledge/`、`output/` の生成ルールを変えた場合は、同じターンでハロワゲートを通す。